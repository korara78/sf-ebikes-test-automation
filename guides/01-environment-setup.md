...
This is covered in detail in **Guide 2: Authentication & Test Session Strategy**, but the file involved is:
...
**Guide 2: Authentication & Test Session Strategy** — configuring `auth.setup.ts`, handling Salesforce login/MFA in Playwright, and structuring reusable session state across the test suite.
